...
namespace NewsApi
{
    public class NewsApiClient
    {
        ...
        public NewsApiClient(string apiKey = "8d70b5ddb3dd41978a30c91163bcdddb")
        {
            ApiKey = apiKey;
        ...
        private async Task<ArticlesResult> MakeRequest(string endpoint, string querystring)
        {
            ...
            var httpRequest = new HttpRequestMessage(HttpMethod.Get, BASE_URL + endpoint + "?apiKey=8d70b5ddb3dd41978a30c91163bcdddb&" + querystring);
